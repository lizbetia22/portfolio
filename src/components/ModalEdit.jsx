...
const ModalEdit = ({language, editingPost, editedTitle, setEditedTitle, editedBody, setEditedBody, editedTags, setEditedTags, setEditingPost, saveEditedPost}) => {

    const editModalData = {
        fr: {
            title_1: 'Modifier le titre',
            title_2: 'Modifier la description',
            title_3: 'Editer les tags',
            title_4: 'Sauvegarder',
            title_5: 'Annuler'
        },
        en: {
            title_1: 'Edit title',
            title_2: 'Edit description',
            title_3: 'Edit tags',
            title_4: 'Save',
            title_5: 'Cancel'
